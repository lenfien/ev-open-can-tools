...
#include <Arduino.h>
    ...
    <div class="card">
        <div class="card-hdr">
            <div class="card-title">WiFi Hotspot <span onclick="toggleInfo('ap-info')"
    ...
    <div class="card">
        <div class="card-hdr">
            <div class="card-title">Plugins <span onclick="toggleInfo('plg-info')"
                                                  style="color:var(--tx3);cursor:pointer;font-size:12px;margin-left:4px"
    ...
    <div class="card">
        <div class="card-hdr">
            <div class="card-title">Plugin Editor <span onclick="toggleInfo('pe-info')"
                                                        style="color:var(--tx3);cursor:pointer;font-size:12px;margin-left:4px"
    ...
    <div class="card">
        <div class="card-hdr">
            <div class="card-title">CAN Pins <span onclick="toggleInfo('can-pins-info')"
                                                   style="color:var(--tx3);cursor:pointer;font-size:12px;margin-left:4px"
    ...
    <div class="card">
        <div class="card-hdr">
            <div class="card-title">Settings Backup <span onclick="toggleInfo('backup-info')"
                                                          style="color:var(--tx3);cursor:pointer;font-size:12px;margin-left:4px"
